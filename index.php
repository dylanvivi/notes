...
<h1>逸笔草草落灯花 | 留言墙 </h1>
<h2>Go back <a href="http://blog.dylanvivi.com">to dylan's blog &raquo;</a></h2>


<div id="main">
	<a id="addButton" class="green-button" href="add_note.html">添加留言</a>
    
	<?php echo $notes?>
    
</div>

<p class="tutInfo">&copy;2012 <a href="http://dylanvivi.com">Dylan</a></p>
